# Student 5 — AI Integration Prompt Artefacts

**Feature:** Staff & Shift Management
**Area:** AI-Mode integration

> **Status:** Template only. No prompts have been recorded yet.
> Record one entry per prompt used during AI-Mode integration work, following the structure
