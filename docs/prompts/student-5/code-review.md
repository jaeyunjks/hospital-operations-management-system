# Student 5 — Code Review Prompt Artefacts

**Feature:** Staff & Shift Management
**Area:** AI-assisted code review

> **Status:** Template only. No prompts have been recorded yet.
> Record one entry per prompt used during AI-assisted code review work, following the structure
