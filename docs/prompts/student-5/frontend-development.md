# Student 5 — Frontend Development Prompt Artefacts

**Feature:** Staff & Shift Management
**Area:** HTMX frontend microservice development

> **Status:** Template only. No prompts have been recorded yet.
> Record one entry per prompt used during HTMX frontend microservice development work, following the structure
