...
The Patient & Admission Management service is part of the shared Compose
stack. This module therefore validates admissions through its HTTP API rather
than reading any other feature's database directly.
"""
